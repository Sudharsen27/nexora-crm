    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-0">
          ...
          {loading ? (
            <p className="p-8 text-center text-zinc-500">Loading contacts...</p>
          ) : contacts.length === 0 ? (
            <p className="p-8 text-center text-zinc-500">No contacts found.</p>
          ) : (
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {contacts.map((contact) => (
                    <tr key={contact.id} className="border-b border-zinc-100 dark:border-zinc-800/50">
